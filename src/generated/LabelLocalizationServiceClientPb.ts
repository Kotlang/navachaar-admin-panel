...
import * as labelLocalization_pb from './labelLocalization_pb';
...
export class LabelLocalizationClient {
  ...
  methodDescriptorGetAllLabelsByLanguage = new grpcWeb.MethodDescriptor(
    '/localization.LabelLocalization/GetAllLabelsByLanguage',
    grpcWeb.MethodType.UNARY,
    labelLocalization_pb.GetAllLabelsByLanguageRequest,
    labelLocalization_pb.LocalizedLabelsResponse,
    (request: labelLocalization_pb.GetAllLabelsByLanguageRequest) => {
      return request.serializeBinary();
    },
    labelLocalization_pb.LocalizedLabelsResponse.deserializeBinary
  );

  getAllLabelsByLanguage(
    request: labelLocalization_pb.GetAllLabelsByLanguageRequest,
  ...
  getAllLabelsByLanguage(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorGetAllLabelsByLanguage,
        callback);
    }
