...
proto.login.CreateProfileRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadatamap: jspb.Message.getFieldWithDefault(msg, 12, ""),
    landsizeinacres: jspb.Message.getFieldWithDefault(msg, 13, 0),
...
/**
 * optional string metaDataMap = 12;
 * @return {string}
 */
...
/**
 * optional LandSizeInAcres landSizeInAcres = 13;
 * @return {!proto.login.LandSizeInAcres}
 */
proto.login.CreateProfileRequest.prototype.getLandsizeinacres = function() {
  return /** @type {!proto.login.LandSizeInAcres} */ (jspb.Message.getFieldWithDefault(this, 13, 0));
};
...
proto.login.CreateProfileRequest.prototype.getLocation = function() {
  return /** @type{?proto.login.Location} */ (
    jspb.Message.getWrapperField(this, common_pb.Location, 14));
};
...
/**
 * @param {string} value
 * @return {!proto.login.GetProfileRequest} returns this
 */
...
/**
 * @param {!Array<!proto.login.UserProfileProto>} value
 * @return {!proto.login.BulkGetProfileResponse} returns this
*/
